...
define([
    ...
    var _11x5HistoryContainer = {
        ...
        showTop: function(num) {
            if(num == 3) {
                $('[data-id=1],[data-id=2]').find('span').addClass('opacity');
            } else if (num == 2) {
                $('[data-id=1],[data-id=2],[data-id=3]').find('span').addClass('opacity');
            } else {
                $('[data-id=1],[data-id=2],[data-id=3],[data-id=4]').find('span').addClass('opacity');
            }
        }
    }
