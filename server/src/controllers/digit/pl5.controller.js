...
import {PL5Service} from '../../services/digit/pl5.service';
...
/**Controller for 'main'*/
class Pl5Controller extends DigitController {

    constructor(){

        super('pl5');

        this._context.name = '排列5';
        this._context.lotteryCode = 'pl5';
        this._context.weekLottery = '每天 20:30开奖';
        this._service = new PL5Service();
    ...
    async index(request, reply) {
        ...
        return this.render(`digit/pl5/index`, _context, request, reply);
    }
    ...
    async indexPage(request, reply) {
        ...
        let _history = __template(this.path.join(__dirname,'../../views/template/digit/pl5/history.art'), _context);
    ...
    async history(request, reply){
        ...
        return this.render(`digit/pl5/history`, _context, request, reply);
    }
    ...
    async chart(request, reply){
        ...
        let [_flot, _lotteryCode, _lotteryClassity] = [request.params.flot, `pl5`, ''];
    ...
    async requestChart(request, reply){
        ...
        let  [_lotteryCode, _flot, _quantity,_chartService,  resultChartData] = [`pl5`, request.query.flot, request.query.quantity, new ChartService()];
        ...
        try{
            ...
            /** 排列五 */
            resultChartData  = _chartService.resultForm(await _chartService.getPl5FlotStatData(_flot, _quantity));
