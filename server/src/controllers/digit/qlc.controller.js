...
import {QLCService} from '../../services/digit/qlc.service';
...
/**Controller for 'main'*/
class QlcController extends DigitController {

    constructor(){

        super('qlc');

        this._context.name = '七乐彩';
        this._context.lotteryCode = 'qlc';
        this._context.weekLottery = '每周一、三、五 21:15开奖';
        this._service = new QLCService();
    ...
    async index(request, reply) {
        ...
        return this.render(`digit/qlc/index`, _context, request, reply);
    }
    ...
    async indexPage(request, reply) {
        ...
        let _history = __template(this.path.join(__dirname,'../../views/template/digit/qlc/history.art'), _context);
    ...
    async history(request, reply){
        ...
        return this.render(`digit/qlc/history`, _context, request, reply);
    }
    ...
    async chart(request, reply){
        ...
        let [_flot, _lotteryCode, _lotteryClassity] = [request.params.flot, `qlc`, ''];
        ...
        try{
            ...
            /** 获取数据集合 */
            _data = await this._service.getDigitLotteryMain();
    ...
    async requestChart(request, reply){
        ...
        let  [_lotteryCode, _flot, _quantity,_chartService,  resultChartData] = [`qlc`, request.query.flot, request.query.quantity, new ChartService()];
        ...
        try{
            ...
            /** 七乐彩 */
            resultChartData  = _chartService.resultForm(await _chartService.getQlcFlotStatData(_flot, _quantity));
