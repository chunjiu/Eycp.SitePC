...
import {FC3DService} from '../../services/digit/fc3d.service';
...
import Fc3dDealWithData  from  '../../dealWithDataConduit/digit/fc3d/fc3d.dealWithData';

/**Controller for 'main'*/
class Fc3dController extends DigitController {

    constructor(){

        super('fc3d');

        this._context.name = '福彩3D';
        this._context.lotteryCode = 'fc3d';
        this._context.weekLottery = '每天 20:30开奖';
        this._service = new FC3DService();
        this._articleService = new ArticleService();

        this.configService = ConfigService;

        /** 专门用在处理数据 */
        this.fc3dDealWithData = Fc3dDealWithData;
    }
    ...
    async index(request, reply) {
        ...
        if(_data){
                ...
                if(_data.awardResult.lotteryCode == 'fc3d'){

                    if(_data.awardResult.redResultList[0] == '' && _data.awardResult.blueResultList[0]  == ''){

                        _data.awardResult.redResultList= ['--','--','--'];
                    }else{
        ...
        return this.render(`digit/fc3d/index`, _context, request, reply);
    }
    ...
    async indexPage(request, reply) {
        ...
        let _history = __template(this.path.join(__dirname,'../../views/template/digit/fc3d/history.art'), _context);
    ...
    async history(request, reply){
        ...
        return this.render(`digit/fc3d/history`, _context, request, reply);
    }
    ...
    async detail(request, reply) {
        ...
        try{
           ...
           if(_context.history.awardCount !=null){
            ...
            /** 处理福彩3d的试机号 */
            _context.history = this.fc3dDealWithData.dealWithTestNumberForFc3d(_context.history);
    ...
    async chart(request, reply){
        ...
        let [_flot, _lotteryCode, _lotteryClassity] = [request.params.flot, 'fc3d', ''];
    ...
    async requestChart(request, reply){
        ...
        let  [_lotteryCode, _flot, _quantity,_chartService,  resultChartData] = ['fc3d', request.query.flot, request.query.quantity, new ChartService()];
        ...
        try{
                ...
                /** fc3d */
                resultChartData  = _chartService.resultForm(await _chartService.getFc3dFlotStatData(_flot, _quantity));
