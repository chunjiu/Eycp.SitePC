...
import {QXCService} from '../../services/digit/qxc.service';
...
/**Controller for 'main'*/
class QxcController extends DigitController {

    constructor(){

        super('qxc');

        this._context.name = '七星彩';
        this._context.lotteryCode = 'qxc';
        this._context.weekLottery = '每周二、五、日 20:30开奖';
        this._service = new QXCService();
    ...
    async index(request, reply) {
        ...
        return this.render(`digit/qxc/index`, _context, request, reply);
    }
    ...
    async indexPage(request, reply) {
        ...
        let _history = __template(this.path.join(__dirname,'../../views/template/digit/qxc/history.art'), _context);
    ...
    async history(request, reply){
        ...
        return this.render(`digit/qxc/history`, _context, request, reply);
    }
    ...
    async chart(request, reply){
        ...
        let [_flot, _lotteryCode, _lotteryClassity] = [request.params.flot, `qxc`, ''];
    ...
    async requestChart(request, reply){
        ...
        let  [_lotteryCode, _flot, _quantity,_chartService,  resultChartData] = [`qxc`, request.query.flot, request.query.quantity, new ChartService()];
        ...
        try{
            ...
            /** 七星彩 */
            resultChartData  = _chartService.resultForm(await _chartService.getQxcFlotStatData(_flot, _quantity));
