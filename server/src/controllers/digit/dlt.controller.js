...
class DltController extends DigitController {
    ...
    constructor(){
        ...
        this._context.lotteryCode = 'dlt';
        this._context.name = '大乐透';
        this._context.weekLottery = '每周一、三、六 20:30开奖';
        this._service = new DLTService();
    ...
    async index(request, reply) {
        ...
        return this.render(`digit/dlt/index`, _context, request, reply);
    }
    ...
    async history(request, reply){
        ...
        return this.render(`digit/dlt/history`, _context, request, reply);
    }
    ...
    async getawardinfobyissueno(request, reply){
        ...
        try{
            ...
            if(_context.history){
                ...
                /** 为了匹配模版中得变量，所以要赋值到award_date中 */
                _context.history.award_date        = _context.history.awardTime;
    ...
    async chart(request, reply){
        ...
        let [_flot, _lotteryCode, _lotteryClassity] = [request.params.flot, `dlt`, ''];
        ...
        let _rowAndColumnForFlot = ['51','52'];
    ...
    async requestChart(request, reply){
        ...
        let  [_lotteryCode, _flot, _quantity,_chartService,  resultChartData] = [`dlt`, request.query.flot, request.query.quantity, new ChartService()];
        ...
        try{
            ...
            /** 大乐透 */
            resultChartData  = _chartService.resultForm(await _chartService.getDltFlotStatData(_flot, _quantity));
