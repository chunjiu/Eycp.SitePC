...
import {SSLService} from '../../services/high/ssl.service';
...
class SslController extends BaseController {
    ...
    async index(request, reply) {
        ...
        let _code = `${request.params.area}ssl`;
        ...
        let _service = new SSLService(_code);
        // 获取数据集合
        ...
        return this.render(`high/ssl/index`, _context, request, reply);
    }
    ...
    async indexPage(request, reply) {
        ...
        let _history = __template(this.path.join(__dirname,'../../views/template/high/ssl/history.art'), _context);
        let _index = __template(this.path.join(__dirname, '../../views/template/high/ssl/index.art'), _context);
    ...
    async history(request, reply){
        ...
        return this.render(`high/ssl/history`, _context, request, reply);
    ...
    async detail(request, reply) {
        ...
        try{
            ...
            return this.render(`${_context.classify}/ssl/detail`, _context, request, reply);
