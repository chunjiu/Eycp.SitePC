...
/**Controller for 'main'*/
class SxytdjController extends BaseController {

    constructor(){

        super();

        this.lotteryCode = 'sxytdj';
    ...
    async index(request, reply) {
        ...
        return this.render(`high/sxytdj/index`, _context, request, reply);
    }
    ...
    async history(request, reply){
        ...
        return this.render(`high/sxytdj/history`, _context, request, reply);
...
module.exports = SxytdjController